...
class Message:
    ...
    def build_shift_dict(self, shift):
        ...
        lower_keys = [i for i in string.ascii_lowercase]
        lower_values = [i for i in string.ascii_lowercase]
        shift_lower_values = lower_values[shift:] + lower_values[:shift]
        upper_keys = [i for i in string.ascii_uppercase]
        upper_values = [i for i in string.ascii_uppercase]
